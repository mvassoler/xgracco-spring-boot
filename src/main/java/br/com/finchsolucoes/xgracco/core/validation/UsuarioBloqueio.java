...
import br.com.finchsolucoes.xgracco.core.validation.impl.UsuarioBloqueioValidator;
...
public @interface UsuarioBloqueio {
    ...
    String MESSAGE = "{br.com.finchsolucoes.xgracco.core.validation.UsuarioBloqueio.message}";
