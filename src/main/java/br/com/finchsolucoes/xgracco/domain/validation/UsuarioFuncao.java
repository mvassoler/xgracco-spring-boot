...
import br.com.finchsolucoes.xgracco.domain.validation.impl.UsuarioFuncaoValidator;
...
public @interface UsuarioFuncao {
    ...
    String MESSAGE = "{br.com.finchsolucoes.xgracco.domain.validation.UsuarioEscritorioFuncao.message}";
